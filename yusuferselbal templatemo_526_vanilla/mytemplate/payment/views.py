...
def success(request): #Pay Success
    return render(request, 'payment/after.html', {'case': 'success'})

def fail(request): #Pay Fail
    return render(request, 'payment/after.html', {'case': 'fail'})
